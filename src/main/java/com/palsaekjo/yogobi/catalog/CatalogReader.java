...
public class CatalogReader {
     ...
     *
     * <p><b>이 규칙을 프론트가 거울처럼 들고 있다</b>(2026-09-20, front v88). '변경 최소'가 지금보다
     * 비쌀 때 "지금 요금제는 5G 전용인데 LTE 로 찾으셨어요" 를 화면이 직접 판정한다 — 서버가 사유를
     * 안 주기 때문이다. 여기를 바꾸면 <b>그 문구가 조용히 거짓이 된다.</b> 같이 고치거나,
     * 사유 필드를 응답에 실어 거울을 없애라(계약 변경이라 승인이 필요하다). G-51 이 그 성질을 지킨다.
     */
